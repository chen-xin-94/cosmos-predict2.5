#!/bin/bash
# Smoke training script for DROID multi-view action-conditioned video generation
# 3 cameras concatenated along width: 180x960
...
torchrun --nproc_per_node=1 --master_port=$((12000 + RANDOM % 10000)) \
    ...
    -- experiment=ac_reason_embeddings_rectified_flow_2b_droid_180_960_smoke \
